...
class Validator extends BaseConstraint
{
    ...
    /**
     * Check & Validates the given data against the schema and return error if object is empty 
     *
     */
            ...
            foreach ($schema->properties as $property => $propertySchema) {
                if($value!=null){
                    if (
                        ...
                        if($value->$property==='' || trim($value->$property) === ''){
                            $this->addErrors([
                                array(
                                    'property' => $property,
                                    'message' => "Empty value found, but string is required"
                                )
                            ]);
                        }
