...
try {
    ...
    $destination_id = isset($request->destination_id) ? $request->destination_id : '';
    ...
    if ($country_id != null) {
        $more .= " AND shipments.destination_country = $country_id";
    }
    if ($destination_id != null) {
        $more .= " AND shipments.destination_city_id = $destination_id";
    }
